...
3. Configure your agent by giving it a **Name : Adventure Work Sales Agent** and **Description:Adventure Work Sales Agent is a custom agent built in Microsoft Copilot Studio and is designed to answer business questions about customers and product sales** that describes its purpose and role. Make sure to save your changes.
